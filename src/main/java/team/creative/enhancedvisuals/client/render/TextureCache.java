...
public abstract class TextureCache {
    ...
    public static TextureCache parse(IResourceManager manager, String domain, String baseLocation) {
        try {
            ...
            if (locations != null) {
                ...
                try {
                    ...
                    if (resource != null) {
                        try {
                            animationSpeed = Integer.parseInt(new BufferedReader(new InputStreamReader(resource.getInputStream(), StandardCharsets.UTF_8))
                                .lines()
